"""Handwritten History Kit: Python-first packet analyzer."""
...
PROJECT = {
  "slug": "handwritten-history-kit",
  "title": "Handwritten History Kit",
  "version": "2.0.0",
  "tagline": "Human-in-the-loop repair queues for historical handwriting and damaged records.",
  "problem": "Historical OCR fails hardest on rare scripts, local names, faded ink, and unfamiliar layouts, exactly where preservation value is highest.",
  "solution": "A confidence-aware transcription workflow that packages page metadata, OCR candidates, uncertainty spans, and reviewer decisions into reusable open data.",
  "required": [
    "page.id",
    "page.language",
    "page.condition",
    "ocr.text",
    "ocr.confidence",
    "review.uncertainSpans"
  ],
  "opportunities": [
    "IIIF adapters",
    "Transkribus imports",
    "name authority linking",
